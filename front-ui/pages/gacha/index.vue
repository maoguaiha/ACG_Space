...
const rarities = [
  { id: 'all', name: '全部', gradient: 'from-indigo-500 to-purple-500' },
  { id: 'SSR', name: 'SSR', gradient: 'from-amber-400 to-orange-500' },
  { id: 'SR', name: 'SR', gradient: 'from-purple-500 to-pink-500' },
  { id: 'R', name: 'R', gradient: 'from-blue-400 to-cyan-400' },
  { id: 'N', name: 'N', gradient: 'from-slate-400 to-slate-500' }
]
...
async function fetchUserPoints() {
  try {
    userPoints.value = await gachaApi.fetchUserPoints()
  } catch (e) {
